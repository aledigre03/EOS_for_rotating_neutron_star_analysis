...
gamma2=6
gamma3=3
p12=density_factor1*p0
p23=density_factor2*p0

crust= np.linspace(p0*0.5792, p0*1.0371, 6)

core1= np.linspace(p0*1.1, p12, 30)

core2= np.linspace((density_factor1+0.1)*p0, p23, 30)

core3= np.linspace((density_factor2+0.1)*p0, 7*p0, 30)
